...
def get_lat_long(country, city):
    geolocator = Nominatim(user_agent='geoapiHard')
...
def transform_wikipedia_data(**kwargs):
    ...
    # Pushing the transformed data to xcom
...
def write_wikipedia_data(**kwargs):
    ...
    data.to_csv('abfs://footballdataenghard@footballdataenghard.dfs.core.windows.net/data/' + file_name,
                storage_options = {
                    'account_key' : 'ENTER AZURE KEY'
                }, index = False)
